...
@ft.component
def load_appearance_settings(self) -> ft.Container:
...
@ft.component
def load_widget_settings(self) -> ft.Container:
...
@ft.component
def load_template_settings(self, selected_template: str = None, selected_type: str = None):
...
@ft.component
def load_resources_settings(self):
...
def SettingsView(app, settings, story=None):
    ...
    def change_settings_category(e: ft.Event):
        idx = e.control.selected_index 
    ...
    nav_rail, _ = ft.use_state(
        ft.NavigationRail(
            selected_index=0,
            bgcolor="transparent",
            on_change=change_settings_category,
                ...
                ft.Row(
                    [
                        ...
                        ft.Container(
                            ...
                            content=load_appearance_settings(settings)
                            if settings_idx == 0
                            else load_widget_settings(settings)
                            if settings_idx == 1
                            else load_template_settings(settings)
                            if settings_idx == 2
                            else load_resources_settings(settings)
                            if settings_idx == 3
                            else None   
                        )
                    ],
